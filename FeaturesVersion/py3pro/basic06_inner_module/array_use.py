...
# 将两个数组的元素进行合并
print(a1.extend([99, 77, 88]))  # None
print(a1)  # array('i', [11, 22, 33, 44, 55, 11, 100, 99, 77, 88])

# 翻转数组
a1.reverse()
print(a1)  # array('i', [88, 77, 99, 100, 11, 55, 44, 33, 22, 11])

# 对数组进行排序输出，不影响原始数组
print(sorted(a1))  # [11, 11, 22, 33, 44, 55, 77, 88, 99, 100]

# array没有sort()方法
# print(a1.sort())  # AttributeError: 'array.array' object has no attribute 'sort'